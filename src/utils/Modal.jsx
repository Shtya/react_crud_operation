...
const Modal = ({open , setOpen , ele , setProducts}) => {
  ...
  //!-------------- Switcher Colors ---------------//
  const [showColors , setShowColors] = useState(ele.colors)
  ...
  open && <div className='modal'>
    <div className='modal-wrapper'>
      <div className="title-header">  <span> Edit Product</span> <span onClick={_=> setOpen(!open)}>x</span> </div>
